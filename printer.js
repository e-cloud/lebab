...
var printComments = require("recast/lib/comments").printComments;
var linesModule = require("recast/lib/lines");
var fromString = linesModule.fromString;
var concat = linesModule.concat;
var normalizeOptions = require("recast/lib/options").normalize;
var getReprinter = require("recast/lib/patcher").getReprinter;
var types = require("recast/lib/types");
var namedTypes = types.namedTypes;
var isString = types.builtInTypes.string;
var isObject = types.builtInTypes.object;
var FastPath = require("recast/lib/fast-path");
...
///!!! here is the hack thing
require("recast/lib/printer").Printer = Printer
...
function genericPrintNoParens(path, options, print) {
    ...
    case "ImportRequireDeclaration":
        ...
        if (n.specifiers &&
          ...
          throw Error('invalid ImportRequireDeclaration')
        }
